...
public class ChargedParticleTest {
    ...
    private static double restMass, charge;
    private static ChargedParticle newtonian;
    private static ChargedParticle relativistic;
    ...
    public void setUp() throws Exception {
        ...
        charge = random.nextDouble();
        newtonian = new ChargedParticle(Framework.NEWTONIAN, state, restMass, charge);
        relativistic = new ChargedParticle(Framework.RELATIVISTIC, state, restMass, charge);
